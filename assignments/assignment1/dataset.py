...
def load_svhn(folder, max_train, max_test):
    ...
    '''
    train_X, train_y = load_data_mat(os.path.join(folder, "train_32x32.mat"), max_train, 17)
    test_X, test_y = load_data_mat(os.path.join(folder, "test_32x32.mat"), max_test, 17)
